  ...
  return (
    <div style={{ background: "var(--color-bg)" }}>
      ...
      <section id="hero" className="relative block w-full" style={{ paddingTop: "140px", paddingBottom: "100px" }}>
        <div className="container-premium relative z-10 max-sm:!px-4">
          <div className="max-w-[1280px] mx-auto">
            <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-start lg:items-center">
              ...
              <motion.div
                ...
                className="w-full max-w-xl mx-auto lg:ml-auto min-w-0 [&_*]:!m-0 max-sm:!max-w-none"
              >
                <div
                  className="shadow-2xl flex flex-col gap-6 p-6 sm:p-8 lg:p-10 w-full box-border"
                  style={{
